...
mkdir -p ./libraries/pll_stream/
mkdir -p ./libraries/pll_sdram/
...
mkdir -p ./libraries/LOG_Generate_0/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/log.mif ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_timing_adapter_0.sv"                  -work timing_adapter_0                          -cdslib ./cds_libs/timing_adapter_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_timing_adapter_0_fifo.sv"             -work timing_adapter_0                          -cdslib ./cds_libs/timing_adapter_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_data_format_adapter_0.sv"             -work data_format_adapter_0                     -cdslib ./cds_libs/data_format_adapter_0.cds.lib                    
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                    -work hps_0_h2f_axi_master_wr_rsp_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -work hps_0_h2f_axi_master_wr_rsp_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work hps_0_h2f_axi_master_wr_rsp_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_rsp_width_adapter.cds.lib
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter.v"                                    -work avalon_st_adapter                         -cdslib ./cds_libs/avalon_st_adapter.cds.lib                        
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_timing_adapter_0.sv"                                    -work timing_adapter_0                          -cdslib ./cds_libs/timing_adapter_0.cds.lib                         
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_sdram.v"                                                -work sdram                                     -cdslib ./cds_libs/sdram.cds.lib                                    
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pll_stream.vo"                                          -work pll_stream                                -cdslib ./cds_libs/pll_stream.cds.lib                               
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pll_sdram.vo"                                           -work pll_sdram                                 -cdslib ./cds_libs/pll_sdram.cds.lib                                
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_hps_0.v"                                                -work hps_0                                     -cdslib ./cds_libs/hps_0.cds.lib                                    
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_vfr_0.vo"                                       -work alt_vip_vfr_0                             -cdslib ./cds_libs/alt_vip_vfr_0.cds.lib                            
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_tpg_0.vo"                                       -work alt_vip_tpg_0                             -cdslib ./cds_libs/alt_vip_tpg_0.cds.lib                            
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_mix_0.vo"                                       -work alt_vip_mix_0                             -cdslib ./cds_libs/alt_vip_mix_0.cds.lib                            
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/log_fifo.v"                                                        -work LOG_Generate_0                            -cdslib ./cds_libs/LOG_Generate_0.cds.lib                           
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/log_generator.v"                                                   -work LOG_Generate_0                            -cdslib ./cds_libs/LOG_Generate_0.cds.lib                           
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/log_rom.v"                                                         -work LOG_Generate_0                            -cdslib ./cds_libs/LOG_Generate_0.cds.lib                           
