...
module soc_system_mm_interconnect_1 (
	...
	wire  [112:0] alt_vip_vfr_0_avalon_slave_agent_rf_source_data;                // alt_vip_vfr_0_avalon_slave_agent:rf_source_data -> alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [112:0] alt_vip_vfr_0_avalon_slave_agent_rsp_fifo_out_data;             // alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_0_avalon_slave_agent:rf_sink_data
	...
	wire  [112:0] alt_vip_mix_0_control_agent_rf_source_data;                     // alt_vip_mix_0_control_agent:rf_source_data -> alt_vip_mix_0_control_agent_rsp_fifo:in_data
	...
	wire  [112:0] alt_vip_mix_0_control_agent_rsp_fifo_out_data;                  // alt_vip_mix_0_control_agent_rsp_fifo:out_data -> alt_vip_mix_0_control_agent:rf_sink_data
	...
	wire  [111:0] alt_vip_vfr_0_avalon_slave_agent_rp_data;                       // alt_vip_vfr_0_avalon_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [111:0] alt_vip_mix_0_control_agent_rp_data;                            // alt_vip_mix_0_control_agent:rp_data -> router_003:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                              // alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire  [111:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_data;          // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_data -> alt_vip_vfr_0_avalon_slave_agent:cp_data
	...
	wire    [1:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_channel;       // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                           // cmd_mux_001:src_data -> alt_vip_mix_0_control_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                          // alt_vip_mix_0_control_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                        // cmd_mux_001:src_channel -> alt_vip_mix_0_control_burst_adapter:sink0_channel
	...
	wire  [111:0] alt_vip_mix_0_control_burst_adapter_source0_data;               // alt_vip_mix_0_control_burst_adapter:source0_data -> alt_vip_mix_0_control_agent:cp_data
	...
	wire    [1:0] alt_vip_mix_0_control_burst_adapter_source0_channel;            // alt_vip_mix_0_control_burst_adapter:source0_channel -> alt_vip_mix_0_control_agent:cp_channel
	...
	wire  [111:0] cmd_demux_src1_data;                                            // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [111:0] cmd_demux_001_src0_data;                                        // cmd_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [111:0] crosser_002_out_data;                                           // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [111:0] cmd_demux_001_src1_data;                                        // cmd_demux_001:src1_data -> crosser_003:in_data
	...
	wire  [111:0] crosser_003_out_data;                                           // crosser_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [111:0] crosser_006_out_data;                                           // crosser_006:out_data -> rsp_mux:sink1_data
	...
	wire  [111:0] rsp_demux_001_src1_data;                                        // rsp_demux_001:src1_data -> crosser_007:in_data
	...
	wire  [111:0] crosser_007_out_data;                                           // crosser_007:out_data -> rsp_mux_001:sink1_data
