...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_timing_adapter_0.sv \
  $QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_timing_adapter_0_fifo.sv \
  $QSYS_SIMDIR/submodules/soc_system_avalon_st_adapter_data_format_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_timing_adapter_0.sv \
  $QSYS_SIMDIR/submodules/soc_system_sdram.v \
  $QSYS_SIMDIR/submodules/soc_system_pll_stream.vo \
  $QSYS_SIMDIR/submodules/soc_system_pll_sdram.vo \
  $QSYS_SIMDIR/submodules/soc_system_hps_0.v \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_vfr_0.vo \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_tpg_0.vo \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_mix_0.vo \
  ...
  $QSYS_SIMDIR/submodules/log_fifo.v \
  $QSYS_SIMDIR/submodules/log_generator.v \
  $QSYS_SIMDIR/submodules/log_rom.v \
